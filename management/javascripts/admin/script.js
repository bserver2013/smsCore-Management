$(function () {
	...
	if(localStorage.clickcount == 0 || localStorage.clickcount == "")
	{
	$("#users0").css("color","#AE432E");
	$(".li0").addClass("current2");
	localStorage.cho = 0;
	}
	...
	{
		var temp = ".cl"+i;
		if(localStorage.cho == i)
		{
				$(temp).css("color","#AE432E");
		}
	}
	for(var i = 0; i<= 9; i++)
	{
		...
		{
			$('#main-nav li '+ temp).slideToggle('slow');
			$(tempr).css("color","#AE432E");
			$(".li"+i).addClass("current2");
			//$(".li"+i).css("background-image","url(../../assets/images/admin/img/bgs/bg_aside_nav_current.png)");	
		} 
		
	}
	//Hide all sub menus
	$('#main-nav li.current a').parent().find('ul').hide();// Slide down the current sub menu
	$('#main-nav li a').click(
		function () {
